...
ABOUT_TEXT = (
    ...
    "and Turkish culture and have a menu of 12–15 items that they rotate seasonally. "
    "The restaurant has a rustic and relaxed atmosphere with moderate prices, making it "
    "a popular place for a meal any time of the day."
)


def about(request):
    about_content = {'about': ABOUT_TEXT}
