...
![Chinook sample database](assets/Picture1.png)
...
Click run to execute the query.
 ...
 ![Select data from Customer table](assets/Picture2.png)
...
![Output result of the select statement](assets/Picture4.png)
